  ...
  res.send(`
    <html>
      ...
      <body style="font-family: Arial; padding: 20px;">
        ...
        <p>Para excluir sua conta e dados do aplicativo BeautySalonX:</p>

        <ol>
          <li>Envie um e-mail para: <b>seuemail@email.com</b></li>
          <li>Informe o e-mail usado no app</li>
          <li>Solicite a exclusão dos seus dados</li>
        </ol>

        <p>Seus dados serão excluídos em até 48 horas.</p>
      </body>
    </html>
  `);
});
